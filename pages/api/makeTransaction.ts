...
import {calculatePrice,calculateTokens} from "../../lib/calculatePrice"
...
async function post(
  ...
  try {
    ...
    const couponInstruction = createTransferCheckedInstruction(
      ...
      tokenAmount.toNumber() * (10 ** tokenMint.decimals), // amount to transfer
      tokenMint.decimals, // decimals of the token - we know this is 0
    )
